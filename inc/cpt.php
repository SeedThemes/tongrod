...
function cptui_register_my_taxes() {
	...
	/**
	 * Taxonomy: สิ่งที่ต้องการ.
	 */

	$labels = [
		"name" => __( "สิ่งที่ต้องการ", "tongrod" ),
		"singular_name" => __( "สิ่งที่ต้องการ", "tongrod" ),
		"menu_name" => __( "สิ่งที่ต้องการ", "tongrod" ),
		"all_items" => __( "สิ่งที่ต้องการทั้งหมด", "tongrod" ),
		"edit_item" => __( "Edit สิ่งที่ต้องการ", "tongrod" ),
		"view_item" => __( "View สิ่งที่ต้องการ", "tongrod" ),
		"update_item" => __( "Update สิ่งที่ต้องการ name", "tongrod" ),
		"add_new_item" => __( "Add new สิ่งที่ต้องการ", "tongrod" ),
		"new_item_name" => __( "New สิ่งที่ต้องการ name", "tongrod" ),
		"parent_item" => __( "Parent สิ่งที่ต้องการ", "tongrod" ),
		"parent_item_colon" => __( "Parent สิ่งที่ต้องการ:", "tongrod" ),
		"search_items" => __( "Search สิ่งที่ต้องการ", "tongrod" ),
		"popular_items" => __( "Popular สิ่งที่ต้องการ", "tongrod" ),
		"separate_items_with_commas" => __( "Separate สิ่งที่ต้องการ with commas", "tongrod" ),
		"add_or_remove_items" => __( "Add or remove สิ่งที่ต้องการ", "tongrod" ),
		"choose_from_most_used" => __( "Choose from the most used สิ่งที่ต้องการ", "tongrod" ),
		"not_found" => __( "No สิ่งที่ต้องการ found", "tongrod" ),
		"no_terms" => __( "No สิ่งที่ต้องการ", "tongrod" ),
		"items_list_navigation" => __( "สิ่งที่ต้องการ list navigation", "tongrod" ),
		"items_list" => __( "สิ่งที่ต้องการ list", "tongrod" ),
	];

	$args = [
		"label" => __( "สิ่งที่ต้องการ", "tongrod" ),
		"labels" => $labels,
		"public" => true,
		"publicly_queryable" => true,
		"hierarchical" => false,
		...
		"show_in_nav_menus" => true,
		"query_var" => true,
		"rewrite" => [ 'slug' => 'stuff', 'with_front' => true, ],
	...
	register_taxonomy( "stuff", [ "need" ], $args );
}
